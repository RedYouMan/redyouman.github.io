...
7. rotazione posizione con V, sintesi vocale per T, M, P
   **Descrittori Obbligatori - Ordine fisso:**
   `T;V;B;N;M;P;`
**Descrittore U facoltativo -  elenco pedoni che possono eseguire la cattura en passant (es. U:d4;f4;)`
...
7. the sentence: position rotation with V, speech synthesis for T, M, P
*Mandatory Descriptors - Fixed Order:*
`T;V;B;N;M;P;`
*Optional Descriptor U - list of pawns that can perform the en passant(eg. U:d4;f4;) 
**Tag** | 
