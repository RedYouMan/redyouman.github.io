---
title: "Specifica ROTN - Rot Notation per Scacchi Accessibili"
description: "T=testo, V=Punto di vista, B=Bianchi, N=Neri, M=Chi muove, P=numero di mossa"
categories: Blog
---

# ROTN v1.5 - Rot Notation Specification
...
7. rotazione posizione con V, sintesi vocale per T, M, P, U
   **Descrittori Obbligatori - Ordine fisso:**
   `T;V;B;N;M;P;`
**Descrittore opzionale U alla fine -  elenco case senza separatore ';', dei pedoni che possono eseguire la cattura enpassant  e per ultima la casa del pedone che può essere catturato  (es. U:d4f4e4;). U diventa utile negli automatismi di sospensione e ripresa partita, oltre a descrizione di posizioni`
** Descrittore opzionale Z alla fine - numero di semimosse (campo 5 fen)
**Descrittore riservato F -perripresa scrittura log della partita
...
1. Lettura di T
2. lettura numero mossa P aumentato di 1 se bianco,
3. dichiarazione di chi ha la mossa in base a M
4. dichiarazione opzionale della presenza dell'enpassant 
...
7. the sentence: position rotation with V, speech synthesis for T, M, P, U
...
*Optional DescriptorZ -number of halfmoves (field 5 fen).
