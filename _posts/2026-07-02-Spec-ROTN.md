...
# ROTN v1.4 - Rot Notation Specification
...
7. rotazione posizione con V, sintesi vocale per T, M, P
   **Descrittori Obbligatori - Ordine fisso:**
   `T;V;B;N;M;P;`
**Descrittore U facoltativo -  elenco case senza separatore ';', dei pedoni che possono eseguire la cattura enpassant  e la casa del pedone che può essere catturato  (es. U:d4f4e4;)`
...
`T;V;B;N;M;P;`
*Optional Descriptor U - list of square, without ';',of pawns that can perform the enand the square of pawn under  passant attack (eg. U:d4f4e4;) 
**Tag** | 
