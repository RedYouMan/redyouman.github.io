...
Se questo è utile ai giocatori vedenti, lo è ancora dieci volte di più per i non vedenti.
Qui vedremo gli elementi di base della scacchiera da conoscere in partenza:
...
- la diagonale a8-h1 passa per e4 ed è bianca
- la diagonale a1-h8 passa per d4 ed è nera

## **Ricavare il colore di una casa**

Bisogna avere delle case di riferimento memorizzate tra quella viste sopra prima e allenarsi a ragionare velocemente fino a che diventa tutto istinttivo.Vediamo degli esempi.
...
- c è dispari (a,b,c)
- 3 è dispari
  La casa a1 è nera per cui c1 è nera e c3 è nera
...
Le traverse sono di tipo riga: prima, seconda fino all'ottava, considerate dal bianco al nero; mentre le traverse colonna sono individuate dalle lettere: a, b, c e cosi via.

## **Memorizzare la posizione dei pezzi**

E' la cosa più difficile ma con allenamento si può ottenere.Qua occorre solo memoria e un metodo per ricordare la posizione di ogni pezzo, colore del pezzo, casa e colore della casa.
...
- Torre nera in a8bianca
- Cavallo nero in b8 nera
  e cosi via.

L'obiettivo non è memorizzare i pezzi ma cosa contengono le case.
...
Iniziamo con un esercizio che prevede Donna nera in c3 e un Cavallo bianco in g1. Il Cavallo bianco deve arrivare in h7 senza andare in case controllate dalla Donna.
La Donna nera è sulla diagonale a1-h8 che è nera, mentre h7 è bianca.
...
Supponendo Ch2, Cg4, Ch6, Cf7, Cg5 e infine Ch7..
Altro esercizio. Aggiungiamo alla Donna nera in c3, una Torre nera in b4. Il cavallo deve raggiungere h6, partendo da g1.
