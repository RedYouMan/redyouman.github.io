...
Sapendo il metodo fin dall’inizio avremmo detto che con 9 numeri accoppiati a due a due avremmo avuto 4 coppie da 10 (=40) e rimaneva fuori il 5 e ovviamente il 10 messo, inizialmente, da parte; quindi per un totale di 55.
Capito il metodo possiamo dire che la somma dei numeri da 1 a 100 fa 5050. Infatti sommeremo
99 + 1 = 100
Possiamo arrivare solo a:
49+ 51= 100
Cioè 49coppie da100 (=4900)  
...
Escludiamo il 10 come nel primo esempio che poi sommiamo alla fine e Chiamiamo S la somma che otteniamo da una coppia, allora possiamo usare la formula S*(S-1)/2
Quindi 10*9/2 = 45 + 10 = 55
Facciamo lo stesso nel secondo esempio escludendo il 100, otteniamo 100*99/2 = 4950 + 100 = 5050
A questo punto perfezioniamo il tutto senza dover escludere e sommare alla fine. Se S = 11 nel primo esempio dalla formula otteniamo direttamente 11*10/2 = 55
Nel secondo esempio dicendo S = 101 otteniamo 101\*100/2 = 5050.
La formula è detta triangolare e ricorda la formula dell’area di un triangolo.
Il vantaggio della formula è che anche per qualche miliardo di numeri possiamo fare il calcolo a mente
Un’ultima osservazione. Se si devono sommare numeri fino a numeri multipli di 10 si scopre una regola semplice. Osservate la tabella successiva, che rende facile ricavarsi il risultato in base ai numeri di partenza multipli di 10.
Numero Valore somma
10 55
100 5050
1000 500500
...
Si osserva facilmente che gli zeri tra i due 5 e alla fine sono tanti quanti quelli del numero di partenza diminuito di uno. Ad esempio 100000 ha 5 zeri per cui tra i due 5 ci sono quattro zeri e anche alla fine dopo il secondo 5.
...
Facciamo 1627 _ 23 Scomponiamo 23 in 20 e 3 . Moltiplichiamo 1627 _ 2 = 3254 che moltiplichiamo per 10 e otteniamo 32540 e ripetendolo per tre volte ce lo memorizziamo. Ora abbiamo 1627 * 3 = 4881 che dobbiamo sommare a 32540 e otteniamo37421.
La cosa funziona per la proprietà distributiva della moltiplicazione. Difatti abbiamo fatto 2*10 + 3) _ 1627.(
Facciamo ora l’esempio di 2650 _ 32
Prendiamo prima il 2. Qui è facile fare 2600 _ 2 = 5200 a cui aggiungere 50 _ 2 = 100 per cui otteniamo 5300 e lo memorizziamo, ripetendolo tre volte.
Ora moltiplichiamo 2600 _ 3 = 7800 a cui aggiungiamo 50 _ 3 = 150 per un totale di 7950. Poiché era 30 e non 3 allora il risultato è 79500 a cui aggiungiamo i 5300 memorizzati e otteniamo il totale 84800.
...
Riconduciamo 300000 a 3 _ 10^5. Ora un anno terrestre è 365 giorni, che moltiplicati per 3 da 1095. Per cui possiamo dire elegantemente che 3 anni luce sono una distanza di 10,95 _ 10^7 Km.
