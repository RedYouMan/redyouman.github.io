...
Tra le cose non pensate per i non vedenti sono facili i seguenti esempi:
...
- letti bellissimi e comodi a due piazze o ad una piazza e mezzo. Sicuramente efficaci ed economici sul tipo Ikea, con cassettoni con tanto di spigoli pronti a ferire le gambe di un non vedente che si azzarda a girare per casa senza un bastone.
...
- superamento barriera digitali locali di bancomat, distributore biglietti metro o fs, pos per bancomat o carta di credito etc.Nel caso del pos è evidente che serve una opportuna sicurezza e privacy, dato che non è sicuro dettare al pos vocalmente il pin.
- standardizzazione delle barriere digitali remote per permettere un maggiore accesso a Internet in modo da consentire l'uso di un conto corrente per le consuete operazioni bancarie, la lettura dei web magazine, selezione programmi di raiplay e simili.
...
- digitare ed ascoltare la digitazione della propria password
...
Manca, quindi, una parte semantica standardizzata di presentation data, sottostante al presentation layer fisico, che possa essere facilmente prelevata e interpretata e fatta sentire dagli screen reader, per guidare il Non Vedente nelle sue operazioni.
